...
def handle_registration_click():
    ...
    window.quit()
    window.destroy()
    subprocess.run(["python", "C:\\Users\\jasmi\\Downloads\\VISKOM VSCODE\\UAS\\main\\gui1.py"])
...
def handle_login_click():
    ...
    window.quit()
    window.destroy()
    subprocess.run(["python", "C:\\Users\\jasmi\\Downloads\\VISKOM VSCODE\\UAS\\main\\homepage.py"])
...
def log_in(username, password):
    ...
    with open("C:\\Users\\jasmi\\Downloads\\VISKOM VSCODE\\UAS\\logindatabase.txt", "r") as file:
        for line in file:
            ...
            stored_username, stored_password = data[1], data[2] if len(data) >= 3 else None
